...
export default function ContactFloat() {
  ...
  return (
    <div
      className={`fixed left-4 top-[5cm] z-40 flex flex-col gap-3 transition-all duration-300 ${
    ...
    >
      <a
        ...
        className="grid place-items-center w-10 h-10 rounded-xl bg-[#eef8f8] text-[#0b3b4f] no-underline border border-brand-blue shadow-[0_8px_20px_rgba(14,165,233,.35)] dark:bg-black dark:text-slate-100 transition-all duration-300 hover:scale-110 hover:shadow-xl hover:bg-brand-green/10 active:scale-95"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="grid place-items-center w-10 h-10 rounded-xl bg-[#eef8f8] text-[#0b3b4f] no-underline border border-brand-blue shadow-[0_8px_20px_rgba(14,165,233,.35)] dark:bg-black dark:text-slate-100 transition-all duration-300 hover:scale-110 hover:shadow-xl hover:bg-emerald-50 active:scale-95"
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <a
        ...
        className="grid place-items-center w-10 h-10 rounded-xl bg-[#eef8f8] text-[#0b3b4f] no-underline border border-brand-blue shadow-[0_8px_20px_rgba(14,165,233,.35)] dark:bg-black dark:text-slate-100 transition-all duration-300 hover:scale-110 hover:shadow-xl hover:bg-blue-50 active:scale-95"
      >
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
