    ...
    <div className="fixed z-50 bottom-4 right-4">
      {!open && (
        <button
          ...
          className="shadow-soft w-14 h-14 rounded-full bg-[#0b3b4f] text-white transition-all duration-300 hover:scale-110 hover:shadow-xl hover:rotate-6 active:scale-95 animate-pulse-glow animate-wiggle-3d flex items-center justify-center"
        >
          <svg
